...
export interface TimeoutInfo {
  /**
   * Optional dependending on the strategy specified in the factory. Compulsory for `Strategy.TIMEOUTS`.
   */
  timeoutId?: TimeoutId;
  /**
...
export interface TimedMap<K, V> extends Map<K, V> {
  /**
   * Set the callbacks which will be executed at the specified time
